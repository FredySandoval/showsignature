...
export const ruleTable = [
  ...
  [
    "Pleasantries",
    "remove",
    "sure, certainly, of course, happy to, I'd be happy to, I'd recommend, thanks, thank you, hope that helps",
  ],
  [
    "Hedging",
    "remove",
    "likely, most likely, maybe, perhaps, I think, it seems, seems like, kind of, sort of, probably",
  ],
  [
    "Hedging phrases",
    "remove",
  ...
  [
    "Connective fluff",
    "remove",
    "however, furthermore, additionally, in addition, therefore, thus, moreover",
  ],
  [
    "Soft wrappers",
    "remove/replace",
    "you should, remember to, make sure to → ensure, you need to → must",
  ],
  [
    "Phrase rewrites",
    "replace",
    "in order to → to, due to the fact that → because, in the event that → if, the reason is because → because",
  ],
  [
    "Word rewrites",
    "replace",
    "utilize → use, implement a solution for → fix, extensive → big, is able to → can, has the ability to → can, does not have → lacks, is not able to → cannot, this issue → issue",
  ],
  [
    "Structure",
    "rewrite",
    "because → sentence split; ultra: cause/causes, leads to, results in → → and drop some conjunctions",
  ],
  [
    "Protection",
    "preserve",
    "code blocks, inline code, markdown links/images, table rows, quoted errors, URLs, env vars, versions, file paths",
  ],
] as const;
